...
exports.ILikeProvider = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../prisma.service");
let ILikeProvider = class ILikeProvider {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async search(query, options) {
        ...
        const whereConditions = terms
            .map((_, index) => `(name ILIKE $${index + 1} OR description ILIKE $${index + 1})`)
            .join(' AND ');
...
FROM products 
WHERE ${terms.map((t) => `(name ILIKE '%${t}%' OR description ILIKE '%${t}%')`).join(' AND ')} 
...
exports.ILikeProvider = ILikeProvider;
exports.ILikeProvider = ILikeProvider = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ILikeProvider);
//# sourceMappingURL=ilike.provider.js.map